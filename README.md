...
1) [Web Relay GO project with specific patches/fixes](https://github.com/jashot7/webrelay/tree/for-messaging-poc)

Follow instructions for building and running the web relay. Ensure that you're using my specific branch above, which has all of the necessary code patches/fixes.

*Note: The webrelay requires openbazaar-go.*

2) Build and Run from this project's directory using npm.
...
3) Navigate to the Chat _tab_ and connect to the web relay. Watch the console for your web relay and ensure its running with no error messages beforehand.

4) Enter a PeerID or use the default one provided. Send and receive chat messages.

## Development Documentation
[Authorize with Web Relay (Subscribe to Web Relay] (https://github.com/OpenBazaar/webrelay/blob/master/docs/auth.md)

[Send Messages to Web Relay] (https://github.com/OpenBazaar/webrelay/blob/master/docs/sending.md)

[Receive Messages from the Web Relay](https://github.com/OpenBazaar/webrelay/blob/master/docs/receiving.md)

[Alternative POC on Messaging](https://webchat.ob1.io)
...
- [OB Data Sync POC](#ob-data-sync-poc)
  - [React App Table of Contents](#react-app-table-of-contents)
